...
const server=http.createServer((req,res)=>{
  ...
  if(req.method==="GET"){
    if(req.url.startsWith("/health")) return send(res,200,{"Content-Type":"application/json"} ,JSON.stringify({ok:true,version:"7.0.0"}));
...
server.listen(PORT,"0.0.0.0",()=>console.log(`ECOM ICS Pairing Tool running on port ${PORT}`));
